...
export default function Edit() {
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        post(admin.stepperPages.update({ stepper_page: page.id }).url, {
            forceFormData: true,
        });
    }

    const currentImage = previewUrl ?? existingImage;

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Stepper Page" />
